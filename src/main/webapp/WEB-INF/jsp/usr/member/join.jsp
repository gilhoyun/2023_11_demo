...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<script>
		const loginForm_onSubmit = function(form) {
			...
			if (form.loginPwChk.value != form.loginPwChk.value) {
	...
	<section class="mt-8 text-xl">
		<div class="container mx-auto px-3">
			<form action="doJoin" method="post" onsubmit="loginForm_onSubmit(this); return false;">
				<div class="table-box-type">
					<table class="table table-lg">
						...
						<tr>
							<th>비밀번호 확인</th>
							<td><input class="input input-bordered input-primary w-9/12" name="loginPwChk" type="text" placeholder="비밀번호확인을 입력해주세요" /></td>
						</tr>
						<tr>
							<th>이름</th>
